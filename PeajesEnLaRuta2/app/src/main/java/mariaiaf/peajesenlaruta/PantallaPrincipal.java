...
public class PantallaPrincipal extends AppCompatActivity
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        Cursor cursor = manejadorBD.select("SELECT * FROM Peaje ORDER BY id ASC");
        ...
        //Cursor cursor1 = manejadorBD.select("SELECT * FROM Peajes ORDER BY id ASC");

        /*while (cursor1.moveToNext())

            ManejadorDeDatos.getInstance().SetearId(
        ...
        listView = (ListView) findViewById(R.id.lv_nombre);
        ...
        listView.setOnItemClickListener(new AdapterView.OnItemClickListener() {
            ...
            public void onItemClick(AdapterView<?> parent, View view, int position, long id) {
                ...
                Intent intencion = new Intent(getApplicationContext(), InformacionPeajes.class);
                intencion.putExtra("Nombre_Peaje", listView.getItemAtPosition(position).toString());
